...
export class DebugService {
  ...
  private setupContextMenu(): void {
    ...
    this.document.addEventListener('contextmenu', (event: MouseEvent) => {
      // Check if clicking on something that should have default context menu (like links or images if desired)
      // For now, consistent with Rclone Manager, override globally.
